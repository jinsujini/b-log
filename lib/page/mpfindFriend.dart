...
import 'package:flutter_application_blog/page/friendpage.dart';

class MpFriends extends StatefulWidget {
  const MpFriends({Key? key}) : super(key: key);

  @override
  _MpFriendsState createState() => _MpFriendsState();
}

class _MpFriendsState extends State<MpFriends> {
